        ...
        for root, dirs, files in os.walk(self.dir_path):
            for fn in files:
                ...
                if fn.endswith(songtypes):
                    ...
                    self.song_lst.append(Songs(song['title'][0], song['artist'][0], song['album'][0], str(datetime.timedelta(seconds=int(song.info.length)))))

    def generate_playlist(self):
        gn_plist = Playlist(name="Generated Playlist")
